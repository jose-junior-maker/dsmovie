...
create table tb_score (valor float(53), movie_id bigint not null, user_id bigint not null, primary key (movie_id, user_id));
...
INSERT INTO tb_score(movie_id, user_id, valor) VALUES (2, 2, 3.0);
